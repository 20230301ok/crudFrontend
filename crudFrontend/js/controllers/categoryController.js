...
document.addEventListener("DOMContentLoaded", ()=>{
    const tableBody =document.querySelector("#categoriesTable tbody"); //TBODY CUERPO DE LA TABALAAAAAAA
    const form = document.getElementById("categoryForm"); //formulario dentro del modal
    const modal = new bootstrap.Modal(document.getElementById("categoryModal")); //mdal
    const lblModal = document.getElementById("categoryModalLabel");//titulo del modal
    const btnAdd = document.getElementById("btnAddCategory"); //btn para arbrir modañ

    init(); //Este metodo permite cargar ñas categorias en la tablaaaaaaaaaaaaaaaaa

    //Accion cuando el boton agregar nueva categoria es presionado (abrir modal)
    btnAdd.addEventListener("click", ()=>{
        form.reset();
        form.categoryId.value = ""; //No enviamos id pq estamos agregando
        ...
        async function loadCategories(){
            try{
                ...
                categories.forEach((cat)=>{
                    ...
                    `;
                    //Funcionalidad para botones de editar :o
                    tr.querySelector(".edit-btn").addEventListener("click", ()=>{
                        ...
                        //El modal se carga hasta que e l formulareee
                        modal.show();
                    });
